              ...
              <div className="space-y-3">
                {[
                  ...
                  <button
                    ...
                    className={`w-full ${isMobile ? 'p-4 text-left' : 'p-4 text-left'} font-medium rounded-lg border-2 transition-all duration-300 ${localProfile.goal === goal.value
...
// Main Profile Module Component (REMOVED Week Planning functionality)
const ProfileModule = ({
  isMobile = false,
